...
# The sub procedure for the AC Volts Freq test
 16.001  RSLT         =
 16.002  HEAD         {AC VOLTS FREQUENCY}
 16.003  DISP         Press the yellow button to select Hz
